...
public class MovementServiceTests
{
    ...
    [Fact]
public async Task CreateAsync_ShouldThrowException_WhenItemNotFound()
{
    // Arrange
    var mockMovementRepository = new Mock<IMovementRepository>();
    var mockItemRepository = new Mock<IItemRepository>();
    ...
    Assert.Equal("Item não encontrado.", exception.Message);
...
[Fact]
public async Task GetByPeriodAsync_ShouldReturnMovementsInPeriod()
{
    // Arrange
    var mockMovementRepository = new Mock<IMovementRepository>();
    var mockItemRepository = new Mock<IItemRepository>();
    ...
    mockMovementRepository
        .Setup(r => r.GetByPeriodAsync(start, end))
        .ReturnsAsync(movements);
    ...
    // Act
    var result = await service.GetByPeriodAsync(start, end);
    ...
    [Fact]
    public async Task GetByPeriodAsync_ShouldReturnEmptyList_WhenNoMovementsInPeriod()
    {
        // Arrange
        var mockMovementRepository = new Mock<IMovementRepository>();
        var mockItemRepository = new Mock<IItemRepository>();
